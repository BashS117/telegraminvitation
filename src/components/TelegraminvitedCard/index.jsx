...
function TelegramInviteCard() {
  return (
    <div className="bg-white mt-4  shadow-lg rounded-[14px] p-6 w-[334px] mx-auto text-center">
      ...
      <p className="text-[#7d7f81] text-sm mb-4">1 468 subscribers</p>
      <p className="text-[#000000] mb-4">Solo gente 😈😉</p>
      <div className="space-y-2 mt-6">
      <button className="bg-[#2481cc] text-white font-bold text-[12px] px-4 py-2 rounded-full relative overflow-hidden">
